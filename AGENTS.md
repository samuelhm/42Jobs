...
├── database/
│   └── migrations/            ← 31 archivos SQL (categorías, keywords, jobs, perfil, user_categories...)
├── frontend/
