...
├── database/
│   └── migrations/            ← 30 archivos SQL (categorías, keywords, jobs, perfil, user_categories...)
├── frontend/
